...
console.log(joe);
//Williams Osunkwo: I turned this function to an arrow function, and per the comment above it did break, so i changed it back to a function expression so i could continue on the other functions below without having the error.
...
// It outputted this = Window {postMessage: ƒ, blur: ƒ, focus: ƒ, close: ƒ, parent: Window, …}. I have no idea what that is, but it looks big
// 2. What is "this" when joe.scopeArrow() is invoked?

// It outputted this = Window {postMessage: ƒ, blur: ƒ, focus: ƒ, close: ƒ, parent: Window, …}. I have no idea what that is, but it looks big

// 3. Explain why "this" is different when an arrow function is used.
// Because arrow functions dont work well with constructors, and it causes "This" to become globally scoped
