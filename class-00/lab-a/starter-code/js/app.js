...
function displayPics(){
  ...
  // because "rando" was declared using const inside the outer while loop scoop of the function but the code statement was trying to access it outside of the while loop scope
  console.log(viewed);
